...
export const TIME_SLOTS: TimeSlot[] = [
  ...
  { id: 's4', label: '12:00-12:50', block: 'am' },
  { id: 's5', label: '1:30-2:20', block: 'pm' },
  { id: 's6', label: '2:30-3:20', block: 'pm' },
  { id: 's7', label: '3:30-4:20', block: 'pm' },
  { id: 's8', label: '4:30-5:20', block: 'pm' },
]
